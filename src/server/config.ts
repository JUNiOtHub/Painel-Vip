...
export const CONFIG: any = {
    ...
    NECK_DOMINANCE: {
        ...
        FORCED_NECK_MULTIPLIER: 185.5,
        DISTANCE_FACTOR: 25.5,
        JUMP_COMPENSATION: 55.5,
        RUN_COMPENSATION: 42.8,
        CROUCH_COMPENSATION: 22.4,
        PRONE_COMPENSATION: 10.5,
        VELOCITY_PREDICTION_BIAS: 35.25
    },
    ANTI_BAN: {
        ENABLED: true,
        JITTER_AMOUNT: 0.05,
        JITTER_VARIATION: 0.03,
        HUMAN_DELAY_MIN: 5,
        HUMAN_DELAY_MAX: 15,
        CRC32_CHECKSUM: true,
        ...
        PADDING_MIN: 16,
        PADDING_MAX: 64,
        BEHAVIOR_VARIATION: 0.05,
        BEHAVIOR_COMPLEXITY: 25,
        MAX_CONSECUTIVE_LOCKS: 15,
        COOLDOWN_AFTER_KILL: 3000,
        ...
        ANTI_BLACKLIST: {
            ...
            BYPASS_LEVEL: 'AURORA_PROTOCOL_ULTRA',
            DPI_BYPASS: true,
            MTU_SPOOFING: true,
