...
export default function App() {
  ...
  useEffect(() => {
    ...
    const terminalLines = [
      "Protocol: GRAVIDADE ABSOLUTA V3 ENABLED",
      "Memory spoofing active: AES-256-V3",
      "Pre-Fire Headlock module injected",
      "Anti-cheat pattern masked successfully",
      "Scanning EntityList for Bone [01] (HEAD)...",
      "Zero-Delay Magnetic Pull Active (1ms)",
      "Headshot synchronization stable",
      "Bypassing hardware identification...",
      "Packet integrity shield verified",
      "Protocol: ANTI_CHEST_LOCK V4 ENABLED",
      "Smart Bone Tracking: Target locked",
    ];
  ...
  const handleInject = async () => {
    setIsInjecting(true);
    setTerminalOutput((prev) => [
      "[NUR] Synchronizing Neural Params...",
      ...prev,
    ]);
      ...
      <div className="fixed left-0 top-0 h-full w-[80px] glass-dark border-r border-white/5 z-[100] hidden lg:flex flex-col items-center py-10 gap-10">
        ...
        <div className="flex flex-col gap-6 flex-1">
          ...
          <SidebarLink
            ...
            tooltip="Bypass Status"
          />
          <SidebarLink
            icon={<Settings />}
            active={activeTab === "settings"}
            onClick={() => setActiveTab("settings")}
            tooltip="Neural Config"
          />
        </div>
      ...
      <main className="lg:ml-[80px] p-6 lg:p-12 max-w-7xl mx-auto pt-24 lg:pt-12 relative z-10 min-h-screen">
        ...
        <div className="mb-12 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          <div className="space-y-1">
            ...
            <p className="text-neutral-500 font-mono text-[10px] tracking-[0.4em] uppercase font-bold opacity-60">
              Version {config.VERSION} // Build_ID:{" "}
            ...
            <div className="flex flex-col lg:flex-row gap-12 relative z-10">
              <div className="lg:w-1/3 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-3xl font-display font-black tracking-tight leading-none uppercase italic">
                    LIGAÇÃO <br />
                    <span className="text-amber-500">DIRETA</span>
                  </h2>
                </div>
                <p className="text-neutral-400 text-sm leading-relaxed">
                  Siga a ordem restrita para injetar o painel no emulador de
                  forma indetectável pelas logs locais.
                </p>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-3 text-[10px] font-mono text-neutral-400 uppercase font-black tracking-widest bg-white/5 p-4 rounded-xl border border-white/10">
                    ...
                    <span>
                      Streaming mode seguro (Não aparece no OBS/Tiktok).
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
                  ...
                  <div className="flex flex-col h-full justify-between gap-12">
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-xl font-display font-black tracking-tight uppercase italic text-amber-500">
                          Motor VIP Famosos
                        </h3>
                      </div>
                      <p className="text-neutral-500 text-sm max-w-sm leading-relaxed">
                        O mesmo Painel utilizado por influenciadores. Inject
                        direto na memória RAM com zero chance de BAN. Smooth
                        totalmente natural (Discreto).
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col h-full justify-between gap-8">
                    <div>
                      <div className="inline-flex items-center gap-2 mb-4">
                        ...
                        <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-neutral-400">
                          Gravidade Absoluta V3
                        </h4>
                      </div>
                      <h3 className="text-2xl font-display font-black tracking-tight italic uppercase mb-2">
                        Pre-Fire Headlock
                      </h3>
                      <p className="text-neutral-500 text-xs">
                        Puxa a mira automaticamente em 1ms para a cabeça antes
                        mesmo de atirar. Zero delay.
                      </p>
                    </div>
                    <div className="flex flex-col gap-2">
                      <AimOption
                        label="CABEÇA (GRAVIDADE EXTREMA)"
                        active={config.NECK_DOMINANCE?.AIM_TARGET === "HEAD"}
                        onClick={() =>
                          setConfigValue("NECK_DOMINANCE", "AIM_TARGET", "HEAD")
                        }
                      />
                      <AimOption
                        label="PESCOÇO (PUXADA LENTA)"
                        active={config.NECK_DOMINANCE?.AIM_TARGET === "NECK"}
                        onClick={() =>
                          setConfigValue("NECK_DOMINANCE", "AIM_TARGET", "NECK")
                        }
                      />
                      <AimOption
                        label="PEITO / ADAPTATIVO"
                  ...
                  <div className="flex flex-col h-full justify-between items-start">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-black/70 text-xs font-medium leading-relaxed">
                        Ative a magia. O bypass protegerá sua conta
                        automaticamente. Bom jogo.
                      </p>
                      <button
              ...
              <div className="lg:col-span-4 flex flex-col gap-6">
                <BentoCard className="flex-1 p-0 flex flex-col overflow-hidden glass-dark min-h-[400px]">
                  <div className="p-5 border-b border-white/5 flex items-center justify-between bg-black/40">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[9px] font-mono font-bold uppercase tracking-[0.3em] text-neutral-500">
                        Live_Console_Feed
                      </span>
                    </div>
                  ...
                  <div className="p-6 flex-1 overflow-y-auto font-mono text-[9px] sm:text-[10px] space-y-3 custom-scrollbar bg-black/20">
                    {terminalOutput.map((l) => (
                      <div
                        key={l.id}
                        className="flex gap-3 text-neutral-400 items-start"
                      >
                        <span className="text-rose-500/50 flex-shrink-0">
                          [{l.time}]
                        </span>
                ...
                <BentoCard className="p-6">
                  <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-neutral-600 mb-6">
                    Security Module
                  </h4>
                  <div className="space-y-4">
                  ...
                  >
                    <Radar
                      className={`w-4 h-4 ${isScanning ? "animate-spin text-rose-500" : ""}`}
                    />
                    Sync Security Layer
                  </button>
                </BentoCard>
            ...
            >
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                  <div className="lg:w-1/3 space-y-6">
                    ...
                    <p className="text-neutral-500 text-sm leading-relaxed">
                      Ajuste os parâmetros do driver VIP. Estes valores
                      controlam a agressividade da rede neural de aiming durante
                      o combate.
                    </p>
                  </div>
                  ...
                  <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-10 bg-black/40 p-8 rounded-[2rem] border border-white/5">
                    <div className="space-y-6">
                      ...
                      <p className="text-[9px] text-neutral-600 font-mono italic">
                        Define a área circular de detecção automática para
                        aquisição de novos alvos.
                      </p>
                    </div>
                    ...
                    <div className="space-y-6">
                      <label className="flex items-center justify-between">
                        ...
                        <span className="text-amber-500 font-mono font-bold text-lg leading-none">
                          {(config.NECK_DOMINANCE?.MAGNETIC_PULL * 100).toFixed(
                            0,
                          )}
                          %
                        </span>
                      ...
                      />
                      <p className="text-[9px] text-neutral-600 font-mono italic">
                        Intensidade do pull "trava-mira". Valores acima de 3.0
                        resultam em imã violento.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <GenericToggle
                  label="Magic Bullet"
                  group="FEATURES"
                  configKey="MAGIC_BULLET"
                  active={config.FEATURES?.MAGIC_BULLET}
                ...
                <GenericToggle
                  label="Head Tracking"
                  group="FEATURES"
                  configKey="HEAD_TRACKING"
                  active={config.FEATURES?.HEAD_TRACKING}
                  onToggle={toggleConfig}
                />
                <GenericToggle
                  label="No Recoil"
                ...
                <GenericToggle
                  ...
                  group="FEATURES"
                  configKey="NO_SPREAD"
                  active={config.FEATURES?.NO_SPREAD}
                  onToggle={toggleConfig}
                />
                <GenericToggle
                  label="Fast Reload"
                  group="FEATURES"
                  configKey="FAST_RELOAD"
                  active={config.FEATURES?.FAST_RELOAD}
                  onToggle={toggleConfig}
                />
                <GenericToggle
                  label="ESP Lines"
                ...
                <GenericToggle
                  label="Antenna 100M"
                  group="FEATURES"
                  configKey="ANTENNA_100M"
                  active={config.FEATURES?.ANTENNA_100M}
                  onToggle={toggleConfig}
                />
                <GenericToggle
                  label="Anti-Ban V3"
                ...
                />
                <GenericToggle
                  label="Packet Culling"
                  group="PERFORMANCE"
                  configKey="PACKET_CULLING"
                  active={config.PERFORMANCE?.PACKET_CULLING}
                  onToggle={toggleConfig}
                />
              </div>
            </motion.div>
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute left-[calc(100%+16px)] top-1/2 -translate-y-1/2 px-4 py-2 glass rounded-xl border border-white/10 opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap z-[200]">
        <span className="text-[10px] font-black uppercase tracking-[0.3em] font-display">
          {tooltip}
        </span>
      </div>
    </div>
...
function MobileTabLink({ icon, label, active, onClick }: any) {
  return (
    ...
    >
      <div
        className={`p-3 rounded-xl ${active ? "bg-white/20" : "bg-neutral-800"}`}
      >
        {React.cloneElement(icon, { className: "w-6 h-6" })}
      </div>
      <span className="font-display font-black tracking-tight text-xl italic uppercase underline-offset-8">
        {label}
      </span>
      {active && (
...
function SectionLabel({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-4 mb-6">
      ...
      <span className="text-[10px] font-black uppercase tracking-[0.5em] text-neutral-600 italic">
        {label}
      </span>
      <div className="h-[1px] flex-1 bg-white/5" />
    </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 w-full">
        <div
          className={`w-10 h-10 rounded-xl flex items-center justify-center font-mono text-xs font-black flex-shrink-0 ${active ? "bg-white text-rose-600" : done ? "bg-emerald-500/20 text-emerald-500" : "bg-neutral-800 text-neutral-500"}`}
        >
          {done ? <CheckCircle2 className="w-5 h-5" /> : id}
        </div>
        <div className="flex flex-col">
          <span
            className={`text-[9px] font-black uppercase tracking-widest ${active ? "text-white/70" : "text-neutral-500"}`}
          >
            {subtitle}
          </span>
          <span className="text-sm font-display font-black uppercase tracking-tight leading-none mt-0.5">
            {title}
          </span>
        </div>
        {active && (
      ...
      <p
        className={`text-[10px] leading-relaxed font-medium ${active ? "text-white/80" : "text-neutral-600"}`}
      >
        {explanation}
      </p>
    </button>
...
function HeaderStat({ label, value, active, color = "text-white" }: any) {
  return (
    <div
      className={`px-5 py-3 rounded-2xl flex flex-col text-center min-w-[100px] ${active ? "bg-white/5 border border-white/10" : ""}`}
    >
      <span className="text-[8px] font-black uppercase tracking-[0.2em] text-neutral-500 mb-1 leading-none">
        {label}
      </span>
      <span
        className={`text-sm lg:text-lg font-display font-black tracking-tight leading-none uppercase italic ${color}`}
      >
        {value}
      </span>
    </div>
...
function StatBlock({ label, value, color }: any) {
  return (
    <div className="space-y-1">
      <span className="text-[8px] font-black uppercase tracking-[0.3em] text-neutral-600 leading-none">
        {label}
      </span>
      <p
        className={`text-lg sm:text-xl font-display font-black tracking-tighter uppercase italic leading-none ${color}`}
      >
        {value}
      </p>
    </div>
...
function AimOption({ label, active, onClick }: any) {
  return (
    ...
    >
      <span
        className={`text-[10px] font-black uppercase tracking-[0.2em] transition-transform ${active ? "translate-x-1" : ""}`}
      >
        {label}
      </span>
      <div
        className={`w-2.5 h-2.5 rounded-full transition-all duration-500 ${active ? "bg-rose-500 glow-rose scale-125" : "bg-neutral-800"}`}
      />
    </button>
  );
}
...
function WeaponCard({ name, type, rarity, stats, sync, glow }: any) {
  return (
    <BentoCard
      className={`p-8 lg:p-10 group overflow-hidden border transition-shadow duration-700 ${glow}`}
    >
      ...
      <div className="relative z-10 flex flex-col h-full justify-between gap-10">
        <div className="space-y-4">
          <div className="flex justify-between items-start">
            <div
              className={`px-3 py-1 rounded text-[8px] font-black uppercase tracking-widest italic border ${rarity === "LEGENDARY" ? "bg-amber-500/10 border-amber-500/30 text-amber-500" : rarity === "MYTHIC" ? "bg-amber-500/10 border-amber-500/30 text-amber-600" : "bg-purple-500/10 border-purple-500/30 text-purple-500"}`}
            >
              {rarity}
            </div>
          ...
          <div>
            <h3 className="text-2xl font-display font-black tracking-tight leading-none mb-1 group-hover:text-amber-500 transition-colors uppercase italic">
              {name}
            </h3>
...
function WeaponStat({ value, label }: any) {
  return (
    <div className="bg-black/40 border border-white/5 p-3 rounded-xl flex flex-col items-center">
      ...
      <span className="text-[8px] font-bold text-neutral-600 uppercase mt-1">
        {label}
      </span>
    </div>
  );
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-6">
        <div
          className={`w-8 h-8 rounded-lg flex items-center justify-center transition-colors ${active ? "bg-rose-500 text-white" : "bg-neutral-800 text-neutral-600"}`}
        >
          <Layers className="w-4 h-4" />
        </div>
        <div
          className={`w-3 h-3 rounded-full ${active ? "bg-rose-500 shadow-[0_0_10px_rgba(225,29,72,0.8)]" : "bg-neutral-800"}`}
        />
      </div>
      <span
        className={`text-[10px] font-black uppercase tracking-[0.2em] ${active ? "text-white" : "text-neutral-500"}`}
      >
        {label}
      </span>
      <span className="text-[8px] font-mono text-neutral-700 mt-1 uppercase font-bold">
        Active Bypass
      </span>
    </motion.button>
  );
